        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <Text style={styles.description}>
                    Os serviços do PetAgenda são fornecidos pela  pessoa jurídica com a Razão Social: Carioca & Amigos, titular da propriedade intelectual sobre aplicativos, conteúdos e demais ativos relacionados à plataforma PetAgenda.  
                    {'\n\n'}
                    1. Do objeto
                    {'\n'}
                    A plataforma visa licenciar o uso de seu aplicativo e demais ativos de propriedade intelectual, fornecendo ferramentas para auxiliar e dinamizar o dia a dia dos seus usuários.
                    A plataforma caracteriza-se pela prestação do seguinte serviço: Serviços de controle e agendamento de cuidados com animais.
                    {'\n\n'}
                    2. Da aceitação
                    {'\n'}
                    ...
                    O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao aplicativo PetAgenda. O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.   
                    O usuário, ao aceitar os Termos e Política de Privacidade, autoriza expressamente a plataforma a coletar, usar, armazenar, tratar, ceder ou utilizar as informações derivadas do uso dos serviços, incluindo todas as informações preenchidas pelo usuário no momento em que realizar ou atualizar seu cadastro, além de outras expressamente descritas na Política de Privacidade que deverá ser autorizada pelo usuário.
                    {'\n\n'}
                    5. Do suporte
                    {'\n'}
                    Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do email petagenda@gmail.com.  
                    {'\n\n'}
                    ...
                    {'\n'}
                    c) pelo cumprimento e respeito ao conjunto de regras disposto nesse Termo de Condições Geral de Uso, na respectiva Política de Privacidade e na legislação nacionall;
                    {'\n'}
                    d) pela proteção aos dados de acesso à sua conta/perfil (login e senha).
                    {'\n\n'}
                    É de responsabilidade da plataforma PetAgenda:  
                    {'\n'}
                    ...
                    {'\n'}
                    c) as informações que foram por ele divulgadas, sendo que informações divulgadas por usuários são de inteira responsabilidade dos próprios usuários;
                    {'\n'}
                    ...
                    O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social Carioca & Amigos, puníveis nos termos da legislação aplicável. 
                    {'\n\n'}
                    8. Das sanções
                    {'\n'}
                    Sem prejuízo das demais medidas legais cabíveis, a razão social Carioca & Amigos poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:
                    {'\n'}
                    a) que violar qualquer dispositivo do presente Termo;
                    {'\n'}
                    b) que descumprir os seus deveres de usuário;
                    {'\n'}
                    c) que tiver qualquer comportamento fraudulento, doloso ou ofensivo.
                    {'\n\n'}
                    9. Da rescisão
                    {'\n'}
                    A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social Carioca & Amigos e o bloqueio de todos os serviços prestados ao usuário.
                    {'\n\n'}
                    10. Das alterações
                    {'\n'}
                    Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte de Carioca & Amigos, para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas pelo pelo aplicativo PetAgenda e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.      
                    {'\n\n'}
